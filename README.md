...
|------|----|---|---|---------|----------|
|3 |DB設計|アプリ作成の全体像を把握するため|作成テーブル users,posts,comments||3|
|3|いいね機能|ユーザーが投稿に対して『いいね』を送り評価するため|投稿詳細ページにハートボタンを設置、非同期通信で『いいね！』をすることできる。|postトップページから投稿を選択すると詳細ページに遷移し、詳細ページの『いいねボタン』をクリックできる。|10|
|3|ユーザー管理機能|新規投稿をしたい人や投稿詳細を見たい人が|新規登録、ログイン、ログアウトができる。ログイン時はログアウト表示がでる。|投稿を閲覧したい人、投稿をしたい人は新規登録、ログインする必要がある。|10|
|3|投稿、一覧表示機能|投稿した内容を全て表示させるため|一覧ではnickname、titleを表示させる。|投稿するとトップページに遷移し、投稿内容が見ることができる。|6|
...
|3|投稿詳細表示機能|投稿内容を詳しく表示させるため。|ログイン中のユーザーは投稿一覧ページから特定の投稿を選択すると詳細ページに遷移する。投稿詳細ページではnickname,title、meal、workout、sex、age、purposeが表示させる。|ログイン中のユーザーは投稿の詳細を閲覧するために、一覧ページから特定の投稿を選び投稿詳細ページへ遷移する。|10|
